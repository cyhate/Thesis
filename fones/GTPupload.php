...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['audio_dataGPT'])) {
    $uploadDir = 'Uploads/'; // Provide the desired upload directory path

    $file = $_FILES['audio_dataGPT'];
    $filename = $file['name'];
    $tmpFilePath = $file['tmp_name'];
	$error = $_FILES['audio_dataGPT']['error'];
    ...
    $uniqueFilename = uniqid('recordGTP-', true) . '.wav';
