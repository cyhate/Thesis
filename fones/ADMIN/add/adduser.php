...
<h5><em>Add User Here:</em></h5>
</br>

    <form method="post" action="adduserscript.php" >
        <table>
			<tr>
            ...
            <tr>
                <td><label><b><em>Password:</em></b></label></td>
			...
			<tr>
                <td><label><b><em>Terms:</em></b></label></td>
			...
			<tr>
                <td><label><b><em>Level:</em></b></label></td>
