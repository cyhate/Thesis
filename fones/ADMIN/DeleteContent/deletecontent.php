...
<title>Delete Content &reg; </title>
...
<h3><em>Delete Content FORM &reg;</em></h3>
</br>
</br>
</br>
</br>
</br>
     <h4><em>Delete Record:</em></h4>
	 </br></br>
    <form method="post" action="deletecontentscript.php" >
        <table border="0.5" >
			<tr>
                <td><label><b><em>Delete Record by ID: </em></b></label></td>
                <td><input type="number" class="form-control" name="recordID" id="recordID"></td>
            </tr>
			<tr>
				<td><br/></td>
                <td><br/></td>
...
<h4><em>Notice: This function it will Delete All the Records from database</em></h4><br>
<form method="post" action="deleteALLcontentscript.php" >
        <table border="0.5" >
            <tr>
                <td><label><b><em>Press Delete button to delete ALL RECORDS:</em></b></label></td>
