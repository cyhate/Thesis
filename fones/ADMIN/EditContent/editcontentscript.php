...
if (isset($_POST['submit']) && isset($_FILES['my_record'])) {
    ...
    $record_upload_path = 'EditUploadsAdmin/'.$new_record_name;
...
$sql = "UPDATE records SET userid='$user_id', full_name='$full_name', email_address='$email_address', place_of_birth='$place_of_birth', birth_date='$birth_date', country='$country', city='$city', gender='$gender', language='$language', refugee='$refugee' WHERE id LIKE '".$_POST["currentid"]."%' ";


if (mysqli_query($con,$sql)) {
	echo '<script type="text/javascript">';
    echo 'alert("Record Edited!");';
    echo 'document.location.href="'; echo getBaseUrl(); echo'ADMIN/EditContent/editcontent.php";';
    echo '</script>';
